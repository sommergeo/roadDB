...
**Function-specific arguments** are only available for certain road_get_* functions. These arguments refine queries in ways that are unique to the corresponding function. Some of them use *exact* search terms, whereas others user *fuzzy* search.
