...
### Useful downloads
- Crosstable of functions and arguments [PDF](https://sommergeo.com/roadDB/materials/functions_and_arguments.pdf)
...
Developed over the past 18 years by the [ROCEEH (The Role of Culture in Early Expansions of Humans) research center](https://www.hadw-bw.de/roceeh), ROAD integrates a wealth of archaeological, anthropological, paleoenvironmental and geographical data from both Africa and Eurasia, covering a timeframe from 3,000,000 to 20,000 years before present.
...
![](../../docs/materials/levels_of_detail.svg){width=350px}
...
![](../../docs/materials/functions_and_arguments.png){width=690px}
...
The tutorial uses the [pipe](https://tidyverse.org/blog/2023/04/base-vs-magrittr-pipe/) operator `|>`, which is a native function since R v4.1, allowing to forward the results from one function into the next one (e.g. `function1() |> function2()`). You can write it by pressing `CTRL+SHIFT+M`.
...
```
As you can see, the map can be customised using the arguments available in  [`tmap::tm_dots()`](https://r-tmap.github.io/tmap/reference/tm_symbols.html).
...
Hohle Fels is known for a number of fascinating finds, including one nearly complete bone flute and fragments of three ivory flutes that were excavated from archaeological layer Vb ([Conard et al. 2009](https://www.nature.com/articles/nature08169)). The radiocarbon ages for this layer were derived from bone and charcoal and were analysed at the Oxford Radiocarbon Accelerator Unit and the Leibniz Laboratory in Kiel.
...
A dedicated tutorial is available for analyzing chronological data from roadDB in conjunction with the [Chronomodel](https://chronomodel.com/) software: [https://github.com/ameliechallier/roadDB_chrono_tutorial](https://github.com/ameliechallier/roadDB_chrono_tutorial).
